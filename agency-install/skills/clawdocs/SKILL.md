...
```bash
# Agency integration
./agency-orchestrator.sh --skill clawdocs --task "<task>"
```

## API Endpoints
- POST /api/clawdocs/execute - Execute with parameters
- GET /api/clawdocs/status - Check skill status
- POST /api/clawdocs/batch - Batch processing
