---
name: glp-gatekeeper
description: GLP-1 agent release gatekeeper - controls when new agents are deployed based on Shannon economy metrics, performance thresholds, and stability checks. Prevents premature deployment of unstable or costly agents. Triggers on agent creation requests, release cycles, or Shannon balance changes.
version: 1.0.0
author: FearClaw
