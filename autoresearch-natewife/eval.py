#!/usr/bin/env python3
"""
Evaluate NateWife responses against criteria.
"""
import sys
import re
...
def eval1_identifies_intervention(scenario, response, ground_truth):
    ...
    alarm_words = ['alert', 'check', 'need', 'action', 'pending', 'unpublished', 'add', 'unlock', 'escalate', 'protect', 'nag', 'quiet']
...
def eval3_concrete_action(response):
    ...
    imperative = ['add', 'check', 'go to', 'run', 'restart', 'publish', 'send', 'write', 'log', 'update']
